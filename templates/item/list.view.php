                ...
                <div class="card" style="width: 100%; height:auto;">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <?php if ($this->isAdmin($this->getUser())) : ?>
                                <span class="badge bg-secondary">Item ID : #
                                    <?php echo $item->getId(); ?></span>
                            <?php endif ?>
                        </ul>
                    </div>
                    ...
                    <?php elseif ($item->getStatus() === 'Reserved') : ?>
                        <div class="d-grid gap-2 d-md-block mx-auto">
                            <a href="" class="btn btn-warning disabled"><?php echo $item->getStatus(); ?></a>
                        </div>
                    <?php elseif ($item->getStatus() === 'Borrowed') : ?>
                        <div class="d-grid gap-2 d-md-block mx-auto">
                            <a href="" class="btn btn-secondary disabled"><?php echo $item->getStatus(); ?></a>
                        </div>
                    <?php elseif ($item->getStatus() === 'Unavailable') : ?>
                        <div class="d-grid gap-2 d-md-block mx-auto">
                            <a href="" class="btn btn-danger disabled"><?php echo $item->getStatus(); ?></a>
                        </div>
                    <?php endif ?>
                </div>
            </div>
